...
function showAnalysisSteps() {
  ...
  var steps = [
    { icon: 'fa-microphone-lines', text: '음성 인식', sub: 'STT 엔진', delay: 0 },
    { icon: 'fa-users', text: '화자 분리', sub: '상담사/환자 구분', delay: 8000 },
    { icon: 'fa-magnifying-glass-chart', text: 'NER + SPIN 분석', sub: '병렬 처리 중', delay: 18000 },
    { icon: 'fa-brain', text: '코칭 리포트 생성', sub: '종합분석', delay: 28000 },
  ...
  var html = '<div class="glass-dark rounded-2xl p-4 border border-brand-500/20">' +
    '<div class="flex items-center gap-2 mb-3">' +
      ...
      '<p class="text-[9px] text-surface-500">Patient Funnel AI</p></div>' +
