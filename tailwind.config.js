...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'glow': '0 0 24px rgba(124, 77, 255, 0.22)',
        'glow-lg': '0 0 48px rgba(124, 77, 255, 0.3)',
        'card': '0 1px 2px rgba(38,12,97,0.04), 0 8px 28px rgba(38,12,97,0.06)',
        'card-hover': '0 4px 16px rgba(38,12,97,0.08), 0 20px 48px rgba(124,77,255,0.12)',
        'float': '0 24px 64px rgba(38,12,97,0.16)',
        'inner-glow': 'inset 0 1px 0 0 rgba(255,255,255,0.12)',
        'neon': '0 0 12px rgba(124,77,255,0.5), 0 0 32px rgba(124,77,255,0.25)',
        'dock': '0 12px 40px rgba(15,10,40,0.45), inset 0 1px 0 rgba(255,255,255,0.08)',
      },
      animation: {
